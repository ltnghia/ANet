...
#include "caffe/layers/camourflage_data2_layer.hpp"
...
CamourflageData2Layer<Dtype>::~CamourflageData2Layer<Dtype>() {
  this->StopInternalThread();
}

template <typename Dtype>
void CamourflageData2Layer<Dtype>::DataLayerSetUp(const vector<Blob<Dtype>*>& bottom,
  ...
  CHECK(transform_param.has_mean_file() == false) << 
         "CamourflageData2Layer does not support mean file";
...
template <typename Dtype>
void CamourflageData2Layer<Dtype>::ShuffleImages() {
...
template <typename Dtype>
void CamourflageData2Layer<Dtype>::load_batch(Batch<Dtype>* batch) {
...
INSTANTIATE_CLASS(CamourflageData2Layer);
REGISTER_LAYER_CLASS(CamourflageData2);
