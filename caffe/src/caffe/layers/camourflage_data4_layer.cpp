...
#include "caffe/layers/camourflage_data4_layer.hpp"
...
CamourflageData4Layer<Dtype>::~CamourflageData4Layer<Dtype>() {
  this->StopInternalThread();
}

template <typename Dtype>
void CamourflageData4Layer<Dtype>::DataLayerSetUp(const vector<Blob<Dtype>*>& bottom,
  ...
  CHECK(transform_param.has_mean_file() == false) << 
         "CamourflageData4Layer does not support mean file";
...
template <typename Dtype>
void CamourflageData4Layer<Dtype>::ShuffleImages() {
...
template <typename Dtype>
void CamourflageData4Layer<Dtype>::load_batch(Batch<Dtype>* batch) {
...
INSTANTIATE_CLASS(CamourflageData4Layer);
REGISTER_LAYER_CLASS(CamourflageData4);
